...
function apidemo_scripts() {
	...
	// wp_enqueue_script( 'apidemo-fetch', get_template_directory_uri() . '/assets/js/fetch.js', array(), time(), true );

	if( is_front_page() ) {
		wp_enqueue_script( 'apidemo-main', get_template_directory_uri() . '/assets/js/main.js', array('wp-api', 'jquery'), time(), true );
	}
